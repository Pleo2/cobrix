...
import type { Template } from "../../../app/(main)/account/@dashboard/templates-manager/data"
...
export function TemplateLibrary({ templates, selectedTemplateId, onSelectTemplate }: TemplateLibraryProps) {
    ...
    return (
        <div className="flex flex-col h-full bg-card rounded-lg border shadow-sm">
            <div className="flex justify-between items-center p-4 border-b">
                ...
                <Button size="sm" className="bg-[#22c55e] hover:bg-[#16a34a] text-black font-medium h-8 text-xs">
            ...
            <div className="flex-1 relative min-h-0">
                ...
                <div className="h-full overflow-y-auto px-4 pb-4  space-y-2.5 mt-12">
